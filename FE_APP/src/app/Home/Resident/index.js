...
const MainInspectorScreen = () => {
  ...
  // userName을 AsyncStorage에서 가져오는 useEffect
  useEffect(() => {
  ...
  const slideScales = {}; // 각 카드의 애니메이션 상태 저장
  const slideData = [
    {
      id: "1",
  ...
  const quickAccessItems = [
    {
      ...
      label: "신고하기",
      onPress: () => navigation.navigate("Report/Resident/index"),
    },
    {
      id: "2",
      icon: require("../../../../assets/images/community.png"),
      label: "커뮤니티",
      onPress: () => navigation.navigate("Community/Resident/index"),
    },
    {
      id: "3",
    ...
    <View style={MainStyles.container}>
      ...
      >
        ...
        <Text style={MainStyles.greeting}>
          {userName ? `${userName}님, 반가워요.` : "입주민님, 반가워요"}
        </Text>
      ...
      <View style={MainStyles.slideHeader}>
        <Text style={MainStyles.slideTitle}>입주민 커뮤니티</Text>
        <TouchableOpacity
          onPress={() => navigation.navigate("Community/Resident/index")}
        >
